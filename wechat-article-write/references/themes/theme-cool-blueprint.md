...
<section style="margin:18px 0 24px;padding:14px 16px;background:#f9fafb;border:1px solid #e5e7eb;border-radius:8px;">
  <p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:#111827;font-weight:700;">{{label1}}<br><span style="font-size:13px;line-height:1.65;color:#2563eb;font-weight:400;word-break:break-all;">{{url1}}</span></p>
  <p style="margin:0;font-size:15px;line-height:1.7;color:#111827;font-weight:700;">{{label2}}<br><span style="font-size:13px;line-height:1.65;color:#2563eb;font-weight:400;word-break:break-all;">{{url2}}</span></p>
</section>
```
